...
export function mountNewApiComponent() {
  ...
  container.id = 'bilingual-new-api-container';
  document.body.appendChild(container);
  containerEl = container;

  container.addEventListener('bilingual:prefill', async (e) => {
...
export function unmountNewApiComponent() {
  const container = document.getElementById('bilingual-new-api-container');
