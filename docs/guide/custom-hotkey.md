...
bilingual translate 支持用户自定义翻译快捷键，让您可以根据个人习惯设置最合适的快捷键组合。
...
1. 点击浏览器扩展栏中的 bilingual translate 图标
2. 找到"鼠标悬浮快捷键"配置项
3. 在下拉菜单中选择"自定义快捷键..."
...
设置完成后，在网页上使用该快捷键配合鼠标位置，即可翻译当前指向的文本。
...
| 快捷键 | 描述 | 推荐场景 |
|--------|------|----------|
| `Ctrl` | Ctrl / Control | 默认选项，最常用 |
| `Alt` | Alt / Option | 避免与页面操作冲突 |
| `Shift` | Shift | 临时触发悬停翻译 |
| `~` | 波浪号键 | 单手操作方便 |
| 自定义组合 | 录制任意有效组合 | 需要避开已有快捷键时 |
...
- `components/CustomHotkeyInput.tsx` - 自定义快捷键输入组件
- `components/Main.tsx` - 主配置界面（集成自定义快捷键）
...
如果您在使用过程中遇到任何问题，请在后续发布的项目仓库中反馈。
